...
if test "$RPIPATCHES" = 1 -a ! -d rpi-patches-$RVER ; then
  ...
  git format-patch -o ../rpi-patches-$RVER 9ece50d8a470ca7235ffd6ac0f9c5f0f201fe2c8
  cd ..
  #rm -fr rpi-linux-5
fi
...
sed -i -e '1 s/5.8.5-1~exp1/5.8.5-1/' linux-5/debian/changelog
...
if test "$RPIPATCHES" = 1 ; then
  ...
  pushd debian/patches
    ...
    #rm -f bugfix/rpi/0113-lan78xx-Debounce-link-events-to-minimize-poll-storm.patch
