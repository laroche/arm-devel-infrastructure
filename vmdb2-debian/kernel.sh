...
sed -i -e '1 s/5.10.40-1/5.10.41-1/' linux-5/debian/changelog
sed -i -e '1 s/unstable/UNRELEASED/' linux-5/debian/changelog
sed -i -e '1 s/experimental/UNRELEASED/' linux-5/debian/changelog
sed -i -e 's,^bugfix/all/bpf-wrap-aux-data-inside-bpf_sanitize_info-container.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/bpf-fix-mask-direction-swap-upon-off-reg-sign-change.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/bpf-no-need-to-simulate-speculative-domain-for-immediates.patch,,g' linux-5/debian/patches/series
