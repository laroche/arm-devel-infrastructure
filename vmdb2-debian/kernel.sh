...
sed -i -e '1 s/5.10.42-1/5.10.43-1/' linux-5/debian/changelog
...
sed -i -e 's,^bugfix/all/xen-netback-take-a-reference-to-the-RX-task-thread.patch,,g' linux-5/debian/patches/series
