...
sed -i -e '1 s/5.10.218/5.10.220/' linux-5/debian/changelog
...
#sed -i -e 's,^debian/fanotify-taint-on-use-of-fanotify_access_permissions.patch,,g' linux-5/debian/patches/series
