...
sed -i -e '1 s/5.10.106/5.10.107/' linux-5/debian/changelog
...
sed -i -e 's,^bugfix/all/tcp-make-tcp_read_sock-more-robust.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/io_uring-return-back-safer-resurrect.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/arm64/arm64-kvm-fix-copy-and-paste-error-in-bhb-templates-for-v5.10-stable.patch,,g' linux-5/debian/patches/series
