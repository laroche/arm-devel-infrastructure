...
sed -i -e '1 s/5.10.140/5.10.142/' linux-5/debian/changelog
...
sed -i -e 's,^bugfix/x86/x86-nospec-Unwreck-the-RSB-stuffing.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/x86/x86-nospec-Fix-i386-RSB-stuffing.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/revert-pci-portdrv-don-t-disable-aer-reporting-in-get_port_device_capability.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/bpf-don-t-redirect-packets-with-invalid-pkt_len.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/net-af_packet-check-len-when-min_header_len-equals-to-0.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/mm-rmap-fix-anon_vma-degree-ambiguity-leading-to-double-reuse.patch,,g' linux-5/debian/patches/series
sed -i -e 's,^bugfix/all/mm-force-tlb-flush-for-pfnmap-mappings-before-unlink_file_vma.patch,,g' linux-5/debian/patches/series
