...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20220916/debian-stable-amd64-20220916.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20220916.zip
...
dd if=debian-stable-amd64-20220916/debian-stable-amd64-20220916.img of=/dev/sdX
```
