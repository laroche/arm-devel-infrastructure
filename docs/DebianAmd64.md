...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20240720/debian-stable-amd64-20240720.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20240720.zip
...
dd if=debian-stable-amd64-20240720/debian-stable-amd64-20240720.img of=/dev/sdX
```
