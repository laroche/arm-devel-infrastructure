...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20210826/debian-stable-amd64-20210826.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20210826.zip
...
dd if=debian-stable-amd64-20210826/debian-stable-amd64-20210826.img of=/dev/sdX
```
