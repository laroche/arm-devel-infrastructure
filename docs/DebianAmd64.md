...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20210215/debian-stable-amd64-20210215.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20210215.zip
...
dd if=debian-stable-amd64-20210215/debian-stable-amd64-20210215.img of=/dev/sdX
```
