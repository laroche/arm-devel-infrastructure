...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20191228/debian-stable-amd64-20191228.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20191228.zip
...
dd if=debian-stable-amd64-20191228/debian-stable-amd64-20191228.img of=/dev/sdX
```
