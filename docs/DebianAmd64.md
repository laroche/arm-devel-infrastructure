...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20251129/debian-stable-amd64-20251129.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20251129.zip
...
dd if=debian-stable-amd64-20251129/debian-stable-amd64-20251129.img of=/dev/sdX
```
