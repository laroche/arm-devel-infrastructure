...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20191208/debian-stable-amd64-20191208.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20191208.zip
...
dd if=debian-stable-amd64-20191208/debian-stable-amd64-20191208.img of=/dev/sdX
```
