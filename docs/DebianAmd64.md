...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20201229/debian-stable-amd64-20201229.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20201229.zip
...
dd if=debian-stable-amd64-20201229/debian-stable-amd64-20201229.img of=/dev/sdX
```
