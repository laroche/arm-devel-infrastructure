...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20230730/debian-stable-amd64-20230730.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20230730.zip
...
dd if=debian-stable-amd64-20230730/debian-stable-amd64-20230730.img of=/dev/sdX
```
