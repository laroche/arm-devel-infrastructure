...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20250323/debian-stable-amd64-20250323.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20250323.zip
...
dd if=debian-stable-amd64-20250323/debian-stable-amd64-20250323.img of=/dev/sdX
```
