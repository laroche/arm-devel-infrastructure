...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20200219/debian-stable-amd64-20200219.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20200219.zip
...
dd if=debian-stable-amd64-20200219/debian-stable-amd64-20200219.img of=/dev/sdX
```
