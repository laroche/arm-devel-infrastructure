...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20210810/debian-stable-amd64-20210810.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20210810.zip
...
dd if=debian-stable-amd64-20210810/debian-stable-amd64-20210810.img of=/dev/sdX
```
