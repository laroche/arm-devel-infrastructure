...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20260707/debian-13-amd64-20260707.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-13-amd64-20260707.zip
...
dd if=debian-13-amd64-20260707/debian-13-amd64-20260707.img of=/dev/sdX
```
