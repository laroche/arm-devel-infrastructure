...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20250310/debian-stable-amd64-20250310.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-amd64-20250310.zip
...
dd if=debian-stable-amd64-20250310/debian-stable-amd64-20250310.img of=/dev/sdX
```
