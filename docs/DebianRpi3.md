...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20190913/debian-stable-rpi3-arm64-20190913.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20190913.zip
...
dd if=debian-stable-rpi3-arm64-20190913/debian-stable-amd64-20190913.img of=/dev/sdX
```
