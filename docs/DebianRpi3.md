...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20200719/debian-stable-rpi3-arm64-20200719.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20200719.zip
...
dd if=debian-stable-rpi3-arm64-20200719/debian-stable-amd64-20200719.img of=/dev/sdX
```
