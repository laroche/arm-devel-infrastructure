...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20250725/debian-stable-rpi3-arm64-20250725.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20250725.zip
...
dd if=debian-stable-rpi3-arm64-20250725/debian-stable-amd64-20250725.img of=/dev/sdX
```
