...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20251129/debian-13-rpi3-arm64-20251129.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-13-rpi3-arm64-20251129.zip
...
dd if=debian-13-rpi3-arm64-20251129/debian-13-amd64-20251129.img of=/dev/sdX
```
