...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20201106/debian-stable-rpi3-arm64-20201106.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20201106.zip
...
dd if=debian-stable-rpi3-arm64-20201106/debian-stable-amd64-20201106.img of=/dev/sdX
```
