...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20200515/debian-stable-rpi3-arm64-20200515.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20200515.zip
...
dd if=debian-stable-rpi3-arm64-20200515/debian-stable-amd64-20200515.img of=/dev/sdX
```
