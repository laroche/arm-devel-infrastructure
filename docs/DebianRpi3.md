...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20231103/debian-stable-rpi3-arm64-20231103.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20231103.zip
...
dd if=debian-stable-rpi3-arm64-20231103/debian-stable-amd64-20231103.img of=/dev/sdX
```
