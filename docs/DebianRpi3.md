...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20200826/debian-stable-rpi3-arm64-20200826.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20200826.zip
...
dd if=debian-stable-rpi3-arm64-20200826/debian-stable-amd64-20200826.img of=/dev/sdX
```
