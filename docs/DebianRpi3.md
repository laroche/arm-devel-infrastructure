...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20220305/debian-stable-rpi3-arm64-20220305.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20220305.zip
...
dd if=debian-stable-rpi3-arm64-20220305/debian-stable-amd64-20220305.img of=/dev/sdX
```
