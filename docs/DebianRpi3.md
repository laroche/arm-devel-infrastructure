...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20200927/debian-stable-rpi3-arm64-20200927.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20200927.zip
...
dd if=debian-stable-rpi3-arm64-20200927/debian-stable-amd64-20200927.img of=/dev/sdX
```
