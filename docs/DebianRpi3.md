...
wget -q https://github.com/laroche/arm-devel-infrastructure/releases/download/v20210925/debian-stable-rpi3-arm64-20210925.zip
# Unpack the zip archive to get the raw image *.img:
unzip debian-stable-rpi3-arm64-20210925.zip
...
dd if=debian-stable-rpi3-arm64-20210925/debian-stable-amd64-20210925.img of=/dev/sdX
```
